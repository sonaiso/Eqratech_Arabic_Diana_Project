...
Inductive 3illa :=
| 3L_Qat3        (* القطع: حذف ساكن الوتد المجموع وإسكان ما قبله *)
| 3L_Hadhf       (* الحذف: حذف السبب الخفيف *)
| 3L_Qaṣr        (* القصر: حذف ساكن السبب الخفيف وإسكان ما قبله *)
| 3L_Batr        (* البتر: الحذف + القطع *)
| 3L_Qatf        (* القطف: العصب + الحذف *)
| 3L_Waqf        (* الوقف: إسكان السابع المتحرك *)
| 3L_Kashf       (* الكشف: حذف السابع المتحرك *)
| 3L_Tash3ith    (* التشعيث: حذف أول الوتد المجموع *)
| 3L_Tarfil      (* الترفيل: زيادة سبب خفيف *)
| 3L_Tadhyil.    (* التذييل: زيادة حرف ساكن *)
